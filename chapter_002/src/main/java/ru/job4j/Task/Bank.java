...
public class Bank {
    // отсутствует конструктор и  get метод для доступа private
    private TreeMap<User, ArrayList<Account>> treemap = new TreeMap<>();
                                               //нет смысла в модифекаторе private при данной записи
    ...
    public void delete(User user) {
        this.treemap.remove(user);   //  использовать this нет необходимости
    }
    ...
    public List<Account> getAccounts(User user) {
     ...
     // тип данных boolean, входящий параметр double, усложненная логика
